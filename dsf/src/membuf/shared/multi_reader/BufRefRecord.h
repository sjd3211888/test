...
#ifndef MEMBUF_SRC_SHARED_MULTI_READER_BUF_REF_RECORD_H
#define MEMBUF_SRC_SHARED_MULTI_READER_BUF_REF_RECORD_H
...
constexpr size_t MULTI_MAX_REF_COUNT = 128U;
struct BufRefRecord {
 ...
 private:
    ...
    std::array<RefNodeNew, MULTI_MAX_REF_COUNT> userPids;
    std::array<RefStateNew, MULTI_MAX_REF_COUNT> userStates;
...
#endif  // MEMBUF_SRC_SHARED_MULTI_READER_BUF_REF_RECORD_H
