...
floating_pt_type returns [TypeCode typecode = null]
	...
	| KW_LONG KW_DOUBLE { $typecode = new PrimitiveTypeCode(Kind.KIND_DOUBLE);}
...
@init {
    ...
    |   (KW_SEQUENCE | KW_LIST)
		LEFT_ANG_BRACKET simple_type_spec { type=$simple_type_spec.typecode; } RIGHT_ANG_BRACKET )
		{
           if(type != null)
           {
               $typecode = new SequenceTypeCode(maxsize, maxsize);
...
@init {
    ...
    |   KW_SET
		LEFT_ANG_BRACKET simple_type_spec { type=$simple_type_spec.typecode; } RIGHT_ANG_BRACKET )
		{
	       $typecode = new SetTypeCode(maxsize, maxsize);
	       $typecode.setContentTypeCode(type);
	    }
    ;
...
@init {
    ...
    |   KW_MAP
		...
		{
	       $typecode = new MapTypeCode(maxsize, maxsize);
...
@init{
    ...
    |   KW_STRING )
	   {$typecode = new StringTypeCode(Kind.KIND_STRING, maxsize, maxsize);}
    ;
...
@init
{
    ...
    |   KW_WSTRING )
	   {$typecode = new StringTypeCode(Kind.KIND_WSTRING, maxsize, maxsize);}
    ;
