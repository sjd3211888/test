...
// 2023-05 ~ 2025-05: Enhancement of idlgen and idl2xml: supporting idl2xml parser, adding tostring/get_type_name interfaces, etc.
// ------------------------------------------------------------------
...
public class BitfieldSpec
{
    ...
    {
        return m_hastype; // Use it as alias of m_type
    }
