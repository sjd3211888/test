...
public class AnnotationDeclaration extends TreeNode implements Definition
{
    ...
    public AnnotationDeclaration(AnnotationDeclaration other)
    {
        super(other);
        ...
        this.m_enums = new Vector<EnumTypeCode>();
        for (EnumTypeCode enum_type : other.getEnums()) {
            this.m_enums.add(new EnumTypeCode(enum_type));
        }
        this.m_consts = new Vector<ConstDeclaration>();
        for (ConstDeclaration const_dec : other.getConstDecls()) {
            this.m_consts.add(new ConstDeclaration(const_dec));
        }
        this.m_typedefs = new Vector<AliasTypeCode>();
        for (AliasTypeCode alias_t : other.getTypeDefs()) {
            this.m_typedefs.add(new AliasTypeCode(alias_t));
        }
    }
