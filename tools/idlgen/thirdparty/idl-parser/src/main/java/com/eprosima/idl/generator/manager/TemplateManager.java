...
// 2023-05 ~ 2025-05: idlgen optimization: support for idl2xml parser, production efficiency improvement, vbs idl to rti idl function, etc.
// ------------------------------------------------------------------
...
public class TemplateManager
{
    ...
    public TemplateManager(String stackTemplateNames, Context ctx, boolean generate_typesc, String language)
    {
        ...
        switch (language) {
            ...
            case "CJ":
                ...
                break;
            case "XML":
                TypeCode.xmltypesgr = StringTemplateGroup.loadGroup("XmlTypes", DefaultTemplateLexer.class, null);
                break;
            case "RUST":
                loadCppGroup(generate_typesc);
                TypeCode.ctypesgr = StringTemplateGroup.loadGroup("CTypes", DefaultTemplateLexer.class, null);
                TypeCode.rusttypesgr = StringTemplateGroup.loadGroup("RustTypes", DefaultTemplateLexer.class, null);
                break;
            case "RTIIDL":
                loadCppGroup(generate_typesc);
                TypeCode.rtiidltypesgr = StringTemplateGroup.loadGroup("idlTypes", DefaultTemplateLexer.class, null);
                TypeCode.xmltypesgr = StringTemplateGroup.loadGroup("XmlTypes", DefaultTemplateLexer.class, null);
            default:
                break;
        }
    ...
    private static void loadCppGroup(boolean generate_typesc) {
        if (generate_typesc) {
