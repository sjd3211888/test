...
// 2025-03 ~ 2025-05: idlgen optimization: support for @vbsconfig, etc.
// ------------------------------------------------------------------
...
public class AnnotationMember
{
    ...
    public String getValue()
    {
        ...
        if (m_typecode.isIsStructType()) // Struct
        {
            return m_value;
        }
        return m_value;
    ...
    public void setValue(String pre_value, String suffix_value)
    {
        m_value = pre_value;
        m_suffix_value = suffix_value;
    }

    public String getSufixValue()
    {
        return m_suffix_value;
    }
    ...
    private String m_suffix_value = null;
}
