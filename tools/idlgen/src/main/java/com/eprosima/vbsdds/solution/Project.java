...
// 2023-07 ~ 2025-05: idlgen optimization: support for XML string interface, cpp generation fix, -rti dependency, typeobject fix, etc.
// ------------------------------------------------------------------
...
public class Project extends com.eprosima.solution.Project
{
    ...
    public boolean isProjectSrcFilesEmpty()
    {
        return m_projectsrcfiles.size() == 0 || m_projectsrcfiles.size() == 1;
    }
